...
<div id="top">
    <ul class="nav">
        ...
        <li><a href="${pageContext.request.contextPath}/goodsListServlet?method=findByPageMVC">商品展示列表</a></li>
    </ul>
    <ul class="nav2">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/goodsListServlet?method=findByPageMVC&currentPage=${pb.currentPage - 1}&rows=5" aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i" >
                    ...
                    <c:if test="${pb.currentPage == i}">
                        <li class="active"><a href="${pageContext.request.contextPath}/goodsListServlet?method=findByPageMVC&currentPage=${i}&rows=5">${i}</a></li>
                    </c:if>
                    <c:if test="${pb.currentPage != i}">
                        <li><a href="${pageContext.request.contextPath}/goodsListServlet?method=findByPageMVC&currentPage=${i}&rows=5">${i}</a></li>
                    </c:if>
                        ...
                        <%--传递的参数是当前页码+1，显示的记录数传递5--%>
                    <a href="${pageContext.request.contextPath}/goodsListServlet?method=findByPageMVC&currentPage=${pb.currentPage + 1}&rows=5" aria-label="Next">
